...
*/
$query  = "INSERT INTO information(id, titre, description, pseudo,auteur,theme, langue, mail, conception_graph, editeur)";
$query .= "VALUES ('','$titre','$description','$pseudo','$auteur', '$theme', '$langue', '$mail','$conception_graph','$editeur')";
//$tmpFilePath
    //  '$filePath.$shortname',
